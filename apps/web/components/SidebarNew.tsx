...
function Sidebar({ clientManager }: { clientManager: ClientManager }) {
    ...
    return (
        <div className={`z-10 h-full w-fit flex`}>
            <div className={`bg-white bg-opacity-50 text-[#081C33] h-full w-56 flex flex-col overflow-x-hidden overflow-y-hidden`}>
                ...
                <div className={`bg-black bg-opacity-10 w-full h-12 mt-auto`}>
