...
function Toolbar({ clientManager }: { clientManager: ClientManager }) {
    ...
    return (
        <div className={`w-[70px] duration-300 transition-all h-full flex justify-center py-5 group`}>
            <div className={`space-y-7`}>
                ...
                >
                    ...
                    <Menu.Item icon={<SwitchHorizontal size={14} />}>Switch Accounts</Menu.Item>
                </Menu>
